...
2. Check `claimed` labels. Anything claimed roughly a week with no branch gets a
...
3. Make at most **two** offers per run, and only under the skill's rules: one open
