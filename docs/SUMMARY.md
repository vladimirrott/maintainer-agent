...
[What this is](introduction.md)

---

# The reasoning

- [What a maintainer actually does](maintainer-doctrine.md)
- [What contains a hostile pull request](containment.md)
- [Forty maintainer situations](user-stories.md)
